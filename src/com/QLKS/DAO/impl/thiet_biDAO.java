...
public class thiet_biDAO extends abstractDAO<thiet_biModel> implements Ithiet_biDAO {
    ...
    public void add(thiet_biModel model) {
       String sql = resourceBundleSQL.getString("add_thiet_bi");
        update(sql, model.getId_LP(),model.getName(),model.getAmount(),model.getCreatedDate(),model.getCreatedBy());
    }
    
    @Override
    public void edit(thiet_biModel model) {
       String sql = resourceBundleSQL.getString("update_thiet_bi");
       update(sql, model.getId_LP(),model.getName(),model.getAmount(),model.getCreatedDate(),model.getCreatedBy(), model.getModifiedDate(),model.getModifiedBy(),model.getId());
    }
